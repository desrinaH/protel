...
function updateHeaterStatus(nodeId, status) {
    fetch(`http://192.168.102.150:3000/actions/${nodeId}`, {
        method: 'POST',
        headers: {
...
function checkAndSetAutoHeaterStatus(nodeId) {
    ...
    fetch(`http://192.168.102.150:3000/actions/auto/${nodeId}`) //mungkin perlu bikin table sendiri buat auto biar gak conflict
